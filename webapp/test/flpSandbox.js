		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample Fiori APP",
									"targetURL": "#commeuusuariocomproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commeuusuariocomproject2-display": {
								"semanticObject": "commeuusuariocomproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.meuusuario.com.project2",
									"url": sap.ui.require.toUrl("com/meuusuario/com/project2")
								}
							}
						}
					}
